...
def get_cars(
    ...
    try:
        ...
        logger.exception("iter_cars failed: %s", e)
        raise HTTPException(
            status_code=502,
            detail={"error": "inventory_unavailable", "message": str(e)},
        ) from e
    ...
    try:
        ...
        logger.exception("apply_filters failed: %s", e)
        raise HTTPException(
            status_code=502,
            detail={"error": "filter_failed", "message": str(e)},
        ) from e
